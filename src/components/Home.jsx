  ...
  return (
    <>
      <div className="home" id="home">
        <main>
          <h1>React Js </h1>
          <p> Web development using Reactjs </p>
        </main>
      </div>
      ...
      <div className="home2">
        ...
        <div>
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias alias quia blanditiis. Libero sint tempora 
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est dignissimos ullam molestiae, modi libero animi ipsam
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum aliquid cupiditate quas deserunt quam possimus, 
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque tempore fugit at nesciunt ipsam reiciendis neque 
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Non, quas delectus? Quod repudiandae eaque ipsam iure earum, amet atque minus
          </p>
        </div>
      </div>
